...
{% example html %}
<bs-card card-title="Card title" style="width: 350px" image-top="http://via.placeholder.com/350x150">
  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  <bs-button href="#">Go somewhere</bs-button>
</bs-card>
{% endexample %}
...
The building block of a card is the card-body. With `bs-card`, any content in between the starting tag and end tag will become the `.card-body`.
...
Card titles are added by using the `card-title` attribute. Links are added and placed next to each other by using the `bs-card-link` element.

Subtitles are added by using the `subtitle` attribute. The `card-title` and the `subtitle` items are placed in a `.card-body` element, and will be aligned nicely.

{% example html %}
<bs-card card-title="Card title" subtitle="Card subtitle" style="width: 350px">
  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
The `image-top` attribute places an image to the top of the card. And the `image-bottom` attribute places an image to the bottom of the card.

{% example html %}
<bs-card style="width: 350px" image-top="http://via.placeholder.com/350x150?text=Image+cap">
  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
</bs-card>
<bs-card style="width: 350px" image-bottom="http://via.placeholder.com/350x150?text=Image+cap">
  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
</bs-card>
{% endexample %}
...
Create lists of content in a card with a flush list group. Note: you should set `body="false"` on the `bs-card` element and `flush` on the `bs-list-group` element. This will ensure the padding is set correctly.

{% example html %}
<bs-card style="width: 350px;" body="false">
  <bs-list-group flush>
...
{% example html %}
<bs-card style="width: 350px;" body="false" header="Featured">
  <bs-list-group flush>
    <bs-list-group-item>Cras justo odio</bs-list-group-item>
    <bs-list-group-item>Dapibus ac facilisis in</bs-list-group-item>
    <bs-list-group-item>Vestibulum at eros</bs-list-group-item>
...
{% example html %}
<bs-card style="width: 20rem;" body="false" image-top="http://via.placeholder.com/350x150?text=Image+cap">
  <bs-card-body card-title="Card title">
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </bs-card-body>
  <bs-list-group flush>
    <bs-list-group-item>Cras justo odio</bs-list-group-item>
...
{% example html %}
<bs-card class="card" header="Featured" card-title="Special title treatment">
